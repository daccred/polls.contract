...
export interface ERC721AOwnersExplicitStartTokenIdMockInterface
...
export interface ERC721AOwnersExplicitStartTokenIdMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721AOwnersExplicitStartTokenIdMockInterface;
